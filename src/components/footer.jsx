    ...
    <footer className="footer">
      ...
      <div className="footer-bottom">
        <div className="social-links">
          <a href="https://github.com/christiandiz0n" target="_blank" rel="noopener noreferrer">
          ...
          <a href="mailto:christianmatthew1213@gmail.com" className="contact-link">
            <svg className="social-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
